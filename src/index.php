                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control arredondar" id="Username" placeholder="Usuario" required="">
                    ...
                    <div class="form-row">
                        <div class="form-group col-xl-6">
                            ...
                            <div class="input-group">
                                ...
                                <label for="CEP"></label>
                                <input type="text" class="form-control arredondar" onblur="carregarCEP()" id="CEP" placeholder="12.123-123" data-error="Por favor, informe um CEP correto." required="">
                            </div>
                            <div class="error help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group col-xl-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control arredondar" id="Logradouro" data-error="Por favor, informe um Logradouro correto." required="">
                            </div>
                            <div class="error help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-xl-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control arredondar" id="Complemento" data-error="Por favor, informe um Complemento correto." required="">
                            </div>
                            <div class="error help-block with-errors"></div>
                        </div>
                        <div class="form-group col-xl-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control arredondar" id="Bairro" data-error="Por favor, informe um Bairro correto." required="">
                            </div>
                            <div class="error help-block with-errors"></div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-xl-8">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control" id="Cidade" placeholder="Brasilia-DF" required="">
