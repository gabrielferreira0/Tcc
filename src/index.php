...
<body id="Conteudo">
    ...
    <div class="navbar  navbar-expand-sm  navbar-dark  mb-4 " role="navigation" style="background: #202020">
        <div href="../index.php">
            <img href="../index.php" class="logo" src="imagens/logo2.png" alt="logo">
        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control arredondar" id="senha-login" placeholder="Senha" maxlength="20" required>
                                </div>
                                <div class="error help-block with-errors"></div>
                            </div>
                        </div>
            ...
            <div class="container" id="cardServicos">
                ...
                <div class="card-columns">
                    <div class="card  col-md-10 cardFormularioSrv">
                        <img class="card-img-top" src="https://i.pinimg.com/564x/d3/82/f1/d382f1287cfd6bfc7b7c2bd57f04184d.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="card  col-md-10 cardFormularioSrv">
                        <img class="card-img-top" src="imagens/encanador.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="card  col-md-10 cardFormularioSrv">
                        <img class="card-img-top" src="https://i.pinimg.com/564x/3b/75/27/3b75276562539e2fc3b073bc2cc83009.jpg" alt="Card image cap">
                        <div class="card-body">
