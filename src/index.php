...
<head>
    ...
    <meta name="description" content="SOLUÇÃO PARA INTERMEDIAR CONTRATAÇÃO DE SERVIÇOS DE PEQUENOS REPAROS">
    <meta property="og:image" content="https://getbootstrap.com/docs/4.5/assets/brand/bootstrap-social-logo.png">
    <link rel="shortcut icon" type="image/x-icon" href="./imagens/thumbnails/tn_logo.png">
...
<div class="container-fluid ">
    <div class="d-flex justify-content-center  geral">
        ...
        <div class="card cardFormulario" id="cardCadastro" style="display: none;">
            <!--            inicia aqui-->
            <div class="card-body">
                <h3 class="text-center titulo">Cadastro Cliente <i class="fas fa-address-card"></i></h3>
