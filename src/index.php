...
<head>
    ...
    <meta property="og:image" content="https://www.wedosvc.com.br/src/imagens/logo.png">
    ...
    <div class="container-fluid ">
        <div class="d-flex justify-content-center geral">
                ...
                <div class="card-body">
                    ...
                    <form id="formularioCadastro" class="formulario" data-toggle="validator" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-center galeria">
                            <div class="d-flex align-items-center d-flex justify-content-center col-4 col-md-4" id="foto" title="Foto de perfil">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control arredondar" id="Username" placeholder="Usuario" maxlength="20" required="">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control arredondar" id="Senha" placeholder="Senha" maxlength="20" required="">
                                </div>
                                <div class="error help-block with-errors"></div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control arredondar" id="Email" placeholder="nome@exemplo.com" data-error="Por favor, informe um email valido." required="">
                            </div>
                            <div class="error help-block with-errors"></div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-xl-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control arredondar" id="CPF" placeholder="123.123.123-00" data-error="Por favor, informe um CPF correto." required="">
                                </div>
                                <div class="error help-block with-errors"></div>
                            </div>
                            <div class="form-group col-xl-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control arredondar phone-mask" id="Telefone" placeholder="(DD) 0000-0000" required="">
                                </div>
                                <div class="error help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-danger testando text-center" id="alerta2" role="alert" style="display: none;">
                            <strong>Erro! </strong> Seu cadastro <strong>não foi realizado!</strong>
                        </div>
                        <div class="alert alert-danger testando text-center" id="alerta3" role="alert" style="display: none;">
                            <strong>Erro! </strong> Username <strong>já cadastrado!</strong>
                        </div>
                        <div class="alert alert-danger testando text-center" id="alerta4" role="alert" style="display: none;">
                            <strong>Erro! </strong> Email <strong>já cadastrado!</strong>
                        </div>
                        <div class="alert alert-danger testando text-center" id="alerta5" role="alert" style="display: none;">
                            <strong>Erro! </strong> CPF <strong>já cadastrado!</strong>
                        </div>

                        <div class="alert alert-danger testando text-center" id="alerta6" role="alert" style="display: none; justify-content: flex-start;">
                            <strong>Erro! </strong> Preencha <strong> todos os campos! </strong>
                        </div>

                        <div class="alert alert-danger testando text-center" id="alerta7" role="alert" style="display: none; justify-content: flex-start;">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control arredondar" id="CPF-login" placeholder="123.123.123-00" max="11" data-error="Por favor, informe um CPF correto." required>
                                </div>
                                <div class="error help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control arredondar" id="senha-login" placeholder="Senha" maxlength="35" required>
                                </div>
                                <div class="error help-block with-errors"></div>
                            </div>
                        </div>
            ...
            <div class="card cardFormulario col-md-3" id="cardCardRecuperar" style="display: none">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control arredondar" id="CPF-recuperar" placeholder="123.123.123-00" max="11" data-error="Por favor, informe um CPF correto." required>
                                </div>
                                <div class="error help-block with-errors"></div>
                            </div>
                        </div>
                ...
                <div class="alert alert-danger testando text-center" id="alertaRecuperar" role="alert" style="display: none; justify-content: flex-start;">
                    <strong>Erro! </strong> Preencha <strong> todos os campos! </strong>
                </div>
                <div class="alert alert-danger testando text-center" id="alertaRecuperar2" role="alert" style="display: none; justify-content: flex-start;">
                    <strong>Erro! </strong> CPF não foi <strong>encontrado!</strong>
                </div>
                <div class="alert alert-success testando text-center" id="alertaRecuperar3" role="alert" style="display: none; justify-content: flex-start;">
                ...
                <div class="card-columns ">
                    ...
                    ?>
                        <div class="card col-md-10  cardFormularioSrv">
                            ...
                            <img class="card-img-top" src="imagens/categoria/<?php echo $value['catfoto'] ?>" alt="Card image cap">
                            <div class="card-body">
